    ...
    <scroller lock-x height="1400px">
      <div>
        ...
        <group title="set height=200">
          <x-textarea :max="200" placeholder="请填写详细信息" :show-counter="false" :height="200" :rows="8"
                      :cols="30"></x-textarea>
        </group>
...
<script>
   import { XTextarea, Group, XInput,Scroller } from 'vux'
